...
- The SD HAL models FatFS's `FF_FS_LOCK = 16`: a 17th concurrently open file is refused (`[SIM] too many open files`), so leaked handles fail in the simulator as they do on the device.
