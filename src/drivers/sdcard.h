...
// Non-blocking read for Core 1's audio pollers: returns SDCARD_BUSY without
// reading when the other core holds the SD card, else as sdcard_fread
// (bytes read, -1 on error). Never blocks, never logs.
